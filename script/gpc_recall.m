% 统计基于Area过滤后的gt召回率
output_dit = 'E:\Work\Work_scut\论文\05.ROI\exp\gap_scut\';
...
%     if(gt_d(i)~=0)
        ...
        bbApply('draw',gt_g(outer,1:4), 'r',2 ,'-');
        line([0 width],[top top],'Color',[1 0 0],'LineWidth',2,'LineStyle','--');
        line([0 width],[center center],'Color',[1 0 0],'LineWidth',2,'LineStyle','--');
        line([0 width],[bottom bottom],'Color',[1 0 0],'LineWidth',2,'LineStyle','--');
        line([0 width],[center_gt center_gt],'Color',[0 1 0],'LineWidth',2,'LineStyle','-');
        h = getframe(hs);
