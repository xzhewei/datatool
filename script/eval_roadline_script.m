...
caltech_gpp = load('E:\Code\maskrcnn-benchmark\output\caltech\190411-S1-G1-8-e2e_frcnn_VGG_16_C4_gpn_8_gpu-Area\inference-noslice-prop\caltech_test_1x_roadline\gpc.mat');
...
scut_gpp = load('E:\Code\maskrcnn-benchmark\output\scut\190411-S1-G1-8-e2e_frcnn_VGG_16_C4_gpn_8_gpu-Area\inference-noslice\scut_test_1x_roadline\gpc.mat');
scut_gt_all = load('E:\Datasets\scut\mat\test25\gt-All.mat');


% caltech_gpp_center = double(caltech_gpp.roadline');
caltech_gpp_center = caltech_gpp.all_gpcs(:,1);
[caltech_gpp_err] = eval_roadline(caltech_gpp_center,caltech_gt_all.gt);
% scut_gpp_center = double(scut_gpp.roadline');
scut_gpp_center = scut_gpp.all_gpcs(:,1);
...
set(plot1(2),'DisplayName','GAP-center','Color',[1 0 0]);
