function [pth,setIds,vidIds,skip,dbName,ext] = dbInfo3( name1, pth )
...
switch name1
  ...
  case 'kaist-visible-all'
    ...
    vidIds={0:8 0:5 0:4 0:1 0:1 0 0:4 0:2 0:2 0 0:1 0:1}; dbName = 'kaist';
  case 'kaist-visible-all-train'
    setIds=0:5;     subdir='kaist-visible'; skip=20; ext='jpg';     % Captured at 20fps
    vidIds={0:8 0:5 0:4 0:1 0:1 0}; dbName = 'kaist';
  case 'kaist-visible-all-test'
    setIds=6:11;    subdir='kaist-visible'; skip=20; ext='jpg'; 
    vidIds={0:4 0:2 0:2 0 0:1 0:1}; dbName = 'kaist';
  case 'kaist-lwir-all-train'
    setIds=0:5;     subdir='kaist-lwir'; skip=20; ext='jpg';     % Captured at 20fps
    vidIds={0:8 0:5 0:4 0:1 0:1 0}; dbName = 'kaist';
